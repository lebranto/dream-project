...
<head>
<meta charset="UTF-8">
<title>패리스독 얼반 원형 돔캐리어 상세페이지</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/catOutdoorDetail.css">
</head>
<body>
...
<div class="detail-container">
    ...
    <div class="product-top">
        <div class="product-image-area">
            <img src="${pageContext.request.contextPath}/resources/img/catkennel2.png" alt="패리스독 얼반원형돔캐리어">
        </div>

        <div class="product-info-area">
            <h1 class="product-title">패리스독 얼반 원형 돔캐리어</h1>
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/catkennelDetail2.png" alt="패리스독 얼반원형돔캐리어 상세정보">
        </div>
        ...
        <div id="deliveryInfo" class="detail-content-box">
            ...
            <div class="delivery-section">
                ...
                <p>[배송예정일은 주문시점(주문순서)에 따른 유동성이 발생하므로 평균 배송일과 차이가 발생할 수 있습니다.]</p>
            </div>
