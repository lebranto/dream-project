...
<div class="detail-container">
    ...
    <div class="product-top">
        ...
        <div class="product-info-area">
            <h1 class="product-title">젤리곰 LED 블링커</h1>
            <div class="product-price">25,000원</div>

            <p class="product-desc">
                야간 산책 시 반려견의 위치를 더 잘 보이게 도와주는 LED 외출용품입니다.<br>
                어두운 곳에서도 시인성을 높여주는 안전용 액세서리입니다.
            </p>
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/ledDetail.png" alt="젤리곰 LED 블링커 상세정보">
        </div>
