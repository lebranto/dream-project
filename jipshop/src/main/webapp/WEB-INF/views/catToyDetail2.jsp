...
<head>
<meta charset="UTF-8">
<title>아보카도 캣닢볼 상세페이지</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/catToyDetail.css">
</head>
<body>
...
<div class="detail-container">
    ...
    <div class="product-top">
        <div class="product-image-area">
            <img src="${pageContext.request.contextPath}/resources/img/cattoy2.png" alt="아보카도 캣닢볼">
        </div>

        <div class="product-info-area">
            <h1 class="product-title">아보카도 캣닢볼</h1>
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/cattoyDetail2.png" alt="아보카도 캣닢볼 상세정보">
        </div>
