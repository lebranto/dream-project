...
<head>
<meta charset="UTF-8">
<title>컬러 웨빙 목줄 미디움 상세페이지</title>
...
<div class="detail-container">
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/목줄미디움디테일.png" alt="컬러 웨빙 목줄 미디움 상세정보">
        </div>
