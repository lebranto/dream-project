...
<head>
<meta charset="UTF-8">
<title>이눔 아워스 캣샴푸 상세페이지</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/catGroomDetail.css">
</head>
<body>
...
<div class="detail-container">
    ...
    <div class="product-top">
        ...
        <div class="product-info-area">
            <h1 class="product-title">이눔 아워스 캣샴푸</h1>
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/catshampooDetail1.png" alt="이눔 아워스 캣샴푸 상세정보">
        </div>
