...
<head>
<meta charset="UTF-8">
<title>펫모드 스카이켄넬 미니 050 상세페이지</title>
...
<div class="detail-container">
    ...
    <div class="product-top">
        ...
        <div class="product-info-area">
            <h1 class="product-title">펫모드 스카이켄넬 미니 050</h1>
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/catkennelDetail1.png" alt="펫모드 스카이켄넬 미니 050 상세정보">
        </div>
