...
<div class="detail-container">
    ...
    <div class="product-top">
        ...
        <div class="product-info-area">
            <h1 class="product-title">페디슨 덴탈케어 치약</h1>
    ...
    <div class="detail-view-wrap">
        <div id="detailInfo" class="detail-content-box">
            <h2>상세정보</h2>
            <img src="${pageContext.request.contextPath}/resources/img/catpasteDetail.png" alt="페디슨 덴탈케어 치약 상세정보">
        </div>
