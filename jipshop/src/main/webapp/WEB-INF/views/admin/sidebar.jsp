...
<nav class="sidebar">
    ...
    <a href="${contextPath}/jipshop/admin/productList" class="sidebar-item <%= "productList".equals(currentMenu) ? "active" : "" %>">
        📋 상품 목록
    </a>

    <div class="sidebar-section">매출</div>
    <a href="${contextPath}/jipshop/admin/salesDaily" class="sidebar-item <%= "salesDaily".equals(currentMenu) ? "active" : "" %>">
        📈 일별 조회
    </a>
    <a href="${contextPath}/jipshop/admin/salesMonthly" class="sidebar-item <%= "salesMonthly".equals(currentMenu) ? "active" : "" %>">
        📅 월별 조회
    </a>
    ...
    <a href="${contextPath}/jipshop/admin/inquiryList" class="sidebar-item <%= "inquiryList".equals(currentMenu) ? "active" : "" %>">
        💬 문의 조회
    </a>
    <a href="${contextPath}/jipshop/admin/reportList" class="sidebar-item <%= "newUser".equals(currentMenu) ? "active" : "" %>">
        🔔 신고 사항
    </a>
</nav>
