...
<header class="site-header">
    ...
    <div class="header-middle">
        <div class="logo-area">
            <a href="#">
                <img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="로고" width=160px>
            </a>
        </div>
        ...
        <div class="icon-area">
            <a href="#">
                <img src="${pageContext.request.contextPath}/resources/images/장바구니.png" alt="장바구니">
            </a>
        </div>
    </div>
